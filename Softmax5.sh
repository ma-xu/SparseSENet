...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 /home/xm0036/DNN/PyTorch/pytorch_imagenet/imagenet.py --netName=SEResNet50 --activation=Softmax --factor=5 --bs=512
